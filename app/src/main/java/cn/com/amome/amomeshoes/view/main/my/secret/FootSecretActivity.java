 ...
 * 
 */
public class FootSecretActivity extends Activity implements OnClickListener {
	private String TAG = "FootSecretActivity";
	...
	private static final int MSG_GET_MEAINFO = 2;
	...
	private FootRulerInfo footRulerInfo;
			...
			case ClientConstant.HANDLER_SUCCESS:
				...
				case MSG_GET_CHECK_FOOT:
					...
					if (footJson.equals("[{}]")) {
						...
						app.FootList = gson.fromJson(footJson,
								new TypeToken<List<FootLookInfo>>() {
								}.getType());
						footLookInfo = app.FootList.get(0);
						// initView();
					}
					if (nickname.equals("0自己")) {
						getTestInfo();
					} else {
						initData();
				...
				case MSG_GET_MEAINFO:
					String meaJson = (String) msg.obj;
					if (meaJson.equals("[{}]")) {
					} else {
						FootMeaList = gson.fromJson(meaJson,
	...
	private void initData() {
		// ****左脚长******************
		if (null == app.FootRulerList) {
			basicList.add(R.drawable.my_sec_lelong); // 暂时用高亮
			basicdatalist.add("未设置");
		} else if (footRulerInfo.lftlong.equals("")
				|| footRulerInfo.lftlong.equals("0")) {
			basicList.add(R.drawable.my_sec_lelong); // 暂时用高亮
			basicdatalist.add("未设置");
		} else {
			basicList.add(R.drawable.my_sec_lelong);
			basicdatalist.add(footRulerInfo.lftlong + "mm");
		}
		// ****左脚宽******************
		if (null == app.FootRulerList) {
			basicList.add(R.drawable.my_sec_lewidth); // 暂时用高亮
			basicdatalist.add("未设置");
		} else if (footRulerInfo.lftwidth.equals("")
				|| footRulerInfo.lftlong.equals("0")) {
			basicList.add(R.drawable.my_sec_lewidth); // 暂时用高亮
			basicdatalist.add("未设置");
		} else {
			basicList.add(R.drawable.my_sec_lewidth);
			basicdatalist.add(footRulerInfo.lftwidth + "mm");
		}
		// ****右脚长******************
		if (null == app.FootRulerList) {
			basicList.add(R.drawable.my_sec_rilong); // 暂时用高亮
			basicdatalist.add("未设置");
		} else if (footRulerInfo.rftlong.equals("")
				|| footRulerInfo.lftlong.equals("0")) {
			basicList.add(R.drawable.my_sec_rilong); // 暂时用高亮
			basicdatalist.add("未设置");
		} else {
			basicList.add(R.drawable.my_sec_rilong);
			basicdatalist.add(footRulerInfo.rftlong + "mm");
		}
		// ****右脚宽******************
		if (null == app.FootRulerList) {
			basicList.add(R.drawable.my_sec_riwidth); // 暂时用高亮
			basicdatalist.add("未设置");
		} else if (footRulerInfo.rftwidth.equals("")
				|| footRulerInfo.lftlong.equals("0")) {
			basicList.add(R.drawable.my_sec_riwidth); // 暂时用高亮
			basicdatalist.add("未设置");
		} else {
			basicList.add(R.drawable.my_sec_riwidth);
			basicdatalist.add(footRulerInfo.rftwidth + "mm");
		}
		// ****脚色******************
		...
		if (nickname.equals("0自己")) {
			// ****足弓******************
			if (null == FootMeaList) {
				basicList.add(R.drawable.test_foot_instep_gray);
				basicdatalist.add("未设置");
			} else if (footMeaInfo.turn.equals("")
					|| footMeaInfo.turn.equals("0")) {
				basicList.add(R.drawable.test_foot_instep_gray);
				basicdatalist.add("未设置");
			} else if (footMeaInfo.turn.equals("高弓足")) {
				basicList.add(R.drawable.test_foot_instep_high);
				basicdatalist.add("高弓足");
			} else if (footMeaInfo.turn.equals("扁平足")) {
				basicList.add(R.drawable.test_foot_instep_flat);
				basicdatalist.add("扁平足");
			} else if (footMeaInfo.turn.equals("正常")) {
				basicList.add(R.drawable.test_foot_instep_normal);
				basicdatalist.add("正常");
			}
			// ****前后旋******************
			if (null == FootMeaList) {
				basicList.add(R.drawable.test_foot_spin_gray);
				basicdatalist.add("未设置");
			} else if (footMeaInfo.turn.equals("")
					|| footMeaInfo.turn.equals("0")) {
				basicList.add(R.drawable.test_foot_spin_gray);
				basicdatalist.add("未设置");
			} else if (footMeaInfo.turn.equals("旋前")) {
				basicList.add(R.drawable.test_foot_spin_front);
				basicdatalist.add("旋前");
			} else if (footMeaInfo.turn.equals("旋后")) {
				basicList.add(R.drawable.test_foot_spin_back);
				basicdatalist.add("旋后");
			} else if (footMeaInfo.turn.equals("正常")) {
				basicList.add(R.drawable.test_foot_spin_normal);
				basicdatalist.add("正常");
			}
		}
	...
	private View layout;
	private TextView tv_pop_title, tv_info1, tv_info2, tv_info3, tv_info4,
			tv_tip;
	...
	protected void onResume() {
		// TODO Auto-generated method stub
		super.onResume();
		MobclickAgent.onPageStart(ClassType.FootSecretActivity);
	...
	protected void onPause() {
		// TODO Auto-generated method stub
		super.onPause();
		MobclickAgent.onPageEnd(ClassType.FootSecretActivity);
