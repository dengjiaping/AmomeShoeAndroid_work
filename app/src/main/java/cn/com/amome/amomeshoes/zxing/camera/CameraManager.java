...
package cn.com.amome.amomeshoes.zxing.camera;
...
public final class CameraManager {
	...
	// //////////////////////打开关闭闪光灯////////////////////////////
	/*
	 * public void openOrCloseLight(boolean open){ if(!open){ //camera =
	 * Camera.open(); // camera.startPreview(); Parameters parameter =
	 * camera.getParameters();
	 * parameter.setFlashMode(Parameters.FLASH_MODE_TORCH);
	 * camera.setParameters(parameter); }else{ Parameters parameter2 =
	 * camera.getParameters();
	 * parameter2.setFlashMode(Parameters.FLASH_MODE_OFF);
	 * camera.setParameters(parameter2); }
	 * 
	 * }
	 */
	// ///////////////////////////////////////////////////////////
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			// topOffset + height);
			int leftOffset = screenResolution.x / 8;
